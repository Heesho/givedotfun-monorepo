            ...
            <div className="slab-panel px-3 py-3">
              ...
              <div className="mt-3 flex items-start gap-3">
                <button
                  ...
                  className="border border-[hsl(var(--foreground)/0.1)] rounded-[var(--radius)] relative flex h-[88px] w-[88px] flex-shrink-0 items-center justify-center overflow-hidden bg-[hsl(var(--foreground)/0.04)] transition-colors hover:bg-[hsl(var(--foreground)/0.08)]"
                >
                  {currentLogoUrl ? (
